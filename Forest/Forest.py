...
def CreateGrassRegion():
    ...
    GrassRegion = Regions.GrassRegion([245, 245], [100, 100])
...
def CreateAnimalRegion():
    #AnimalRegion = Regions.AnimalRegion([random.randint(1, 1000), random.randint(1, 1000)], [100, 100])
    AnimalRegion = Regions.AnimalRegion([230, 230], [100, 100])
    plants_sprites.add(AnimalRegion)
    all_sprites.add(AnimalRegion)
    AnimalRegion.Number = 2000
    Env.Elements.append(AnimalRegion)
    Env.Alive.append(AnimalRegion)
